        ...
        public async Task<bool> SendMail(List<string> to, List<string> cc, List<string> bcc, string subject, string body)
        {
            try
            {
                ...
                if (to != null)
                {
                    ...
                    {
                        mailMessage.To.Add(new MailboxAddress(this._senderName, email));
                    }
                }
                #endregion
                ...
                if (cc != null)
                {
                    ...
                    {
                        mailMessage.Cc.Add(new MailboxAddress(this._senderName, email));
                    }
                }
                #endregion
                ...
                if (bcc != null)
                {
                    ...
                    {
                        mailMessage.Bcc.Add(new MailboxAddress(this._senderName, email));
                    }
                }
                #endregion
